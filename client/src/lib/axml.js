// Binary Android XML decoder — ES module adaptation of public/axml.js
...
function readUtf8(dv, off) {
  ...
  return new TextDecoder('utf-8').decode(new Uint8Array(dv.buffer, dv.byteOffset + p, byteLen))
}
...
function readUtf16(dv, off) {
  ...
  return new TextDecoder('utf-16le').decode(new Uint8Array(dv.buffer, dv.byteOffset + off, charLen * 2))
}
...
export function parseAXML(uint8) {
